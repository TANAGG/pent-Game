...
function setup() {
  ...
  ground1 = new Ground(240,440,170,15);
  ground2 = new Ground(860,290,170,15);
  pent = new Pentagon(50,300,40,40);
  tar1 = new Tar(180,400,40,70);
  tar2 = new Tar(240,400,40,70);
  tar3 = new Tar(300,400,40,70);
  tar4 = new Tar(210,330,40,70);
  tar5 = new Tar(270,330,40,70);
  tar6 = new Tar(240,260,40,70);
  ...
  slingshot = new SlingShot(pent.body,{x: 400,y: 300});
}
